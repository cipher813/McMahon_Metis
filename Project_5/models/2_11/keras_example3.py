...
text = convert_midis_to_notes(midi_files) # list of notes
# print(text)
...
print("Len each sentence: {}".format(len(sentences[0])))
print("Len Next chars: {}".format(len(next_chars)))
print("Len each next char: {}".format(len(next_chars[0])))
print("Next chars: {}".format(next_chars))
...
def on_epoch_end(epoch, logs):
    ...
    for diversity in [0.2, 0.5, 1.0, 1.2]:
        ...
        for i in range(400):
            ...
            sentence = sentence[1:].append(next_char)
