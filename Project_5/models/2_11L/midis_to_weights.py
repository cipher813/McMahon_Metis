...
def midis_to_weights(midi_files, output_tag, sequence_length):
    ...
    model, weight_file, history = nn.train_model(model, network_input_r, network_output_r, epochs, batch_size, output_tag, sequence_length)
    return weight_file, notes, history
