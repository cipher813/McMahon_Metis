...
weight_file = 'output/201804010936-audio_output-1-200-weight-01-6.4542-10.0794.hdf5'
note_file = 'output/201804010936-audio_output-1-200-input_notes'
...
def weights_to_midi(note_file, sequence_length, weight_file, temperature, offset_adj):
    ...
    output_notes = cr.create_midi(prediction_output, output_tag, sequence_length, offset_adj)
    return output_notes
...
weights_to_midi(note_file, sequence_length, weight_file, temperature, offset_adj)
